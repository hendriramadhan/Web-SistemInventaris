<?php
	include"koneksi.php";
	$query = mysql_query("SELECT * FROM barang WHERE keterangan LIKE 'Perbaikan%' order by barang asc");
		...
		echo" <tr";  
			...
			echo" bgcolor='$warna'>"; ?>
					...
					<?php
							...
							?>
					<td><a href="hapusbarangperbaikan.php?kode=<?php echo "$tampil[no_barang]"; ?>"><img src="image/ico/hapus.png" title="Hapus <?php echo "$tampil[barang]"; ?>"></a></td>
					<?php } ?>
							<?php
						}
					?>
